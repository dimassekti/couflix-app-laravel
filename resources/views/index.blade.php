...
<head>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/video.js/7.10.2/video-js.min.css"
        rel="stylesheet">
  <link rel="stylesheet"
        href="{{ asset('stream/assets/css/videojs.css') }}">
...
<body>
  ...
  <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
    <img src="{{ asset('stream/assets/images/green_radial.svg') }}"
         class="absolute"
         alt="stream" />
    <img src="{{ asset('stream/assets/images/red_radial.svg') }}"
    ...
    <nav class="container py-5 relative">
      <div class="flex flex-col w-full lg:flex-row lg:items-center">
        ...
        <div class="flex items-center justify-between block lg:hidden">
          ...
          <div>
            <button class="p-1 outline-none mobile-menu-button"
                    data-target="#navigation">
              <svg class="text-white w-7 h-7"
                   fill="none"
                   stroke="currentColor"
                   viewBox="0 0 24 24"
        ...
        <div id="navigation"
          ...
          <div class="flex flex-col items-baseline lg:justify-between mt-6 lg:flex-row lg:items-center lg:mt-0">
            ...
            <a href="/"
               class="hidden lg:block -ml-36">
              <img src="{{ asset('stream/assets/images/stream.svg') }}"
                   alt="stream" />
            </a>
            <div class="flex flex-col w-full font-normal lg:w-auto lg:gap-12 lg:items-center lg:flex-row">
    ...
    <section class="py-[100px] flex flex-col items-center gap-5 px-3 relative">
      ...
      <a href="{{ route('member.register') }}"
         class="mt-5 rounded-full bg-indigo-600 text-center py-3 px-11">
        <span class="text-white font-semibold text-base">Get Started</span>
      </a>
    </section>

    <section id="stream"
             class="px-4 relative max-w-[950px] overflow-hidden mx-auto">
      <!-- modal button & modal background -->
      <div class="w-full relative flex">
        <img src="{{ asset('stream/assets/images/temp_img.png') }}"
             class="object-cover rounded-[50px]"
             alt="stream" />
        <button id="stream-preview"
                class="absolute z-10 top-[50%] left-[50%] -mt-[25px] -ml-[25px] md:-mt-[44px] md:-ml-[44px]
                    cursor-pointer">
          <img src="{{ asset('stream/assets/images/ic_play.svg') }}"
    ...
    <section class="relative">
      <div id="openStream"
           class="max-w-screen hidden h-full mx-auto bg-black bg-opacity-70 fixed z-30 inset-0">
      </div>
      <video-js id="stream-video"
    ...
    <section
            ...
            relative">
      <img src="{{ asset('stream/assets/images/logo-apple-tv.svg') }}"
           alt="stream" />
      <img src="{{ asset('stream/assets/images/logo-ipad-apple.svg') }}"
           alt="stream" />
      <img src="{{ asset('stream/assets/images/logo-android-wordmark.svg') }}"
           alt="stream" />
      <img src="{{ asset('stream/assets/images/logo-youtube-tv.svg') }}"
           alt="stream" />
    </section>
  </header>
