...
@section('content')
  ...
  <div class="flex gap-14 items-start">
    <a href="{{ route('member.dashboard') }}">
      <img src="{{ asset('stream/assets/images/ic_arrow-left-normal.svg') }}"
           alt="">
    </a>
    <div class="flex flex-col gap-10">
      <!-- Thumbnail -->
      <div class="w-full relative overflow-hidden group">
        <img src="{{ asset('stream/assets/images/featured-2.png') }}"
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="inline-flex items-center gap-[6px]">
          <img src="{{ asset('stream/assets/images/ic_star.svg') }}"
               alt="">
          <img src="{{ asset('stream/assets/images/ic_star.svg') }}"
               alt="">
          <img src="{{ asset('stream/assets/images/ic_star.svg') }}"
